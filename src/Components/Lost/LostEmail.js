...
class LostEmail extends Component {
    constructor() {
        super();
        this.state = {
    ...
    nextStep = () =>{
        if(this.state.emailInputValidation.isValid){
                    ...
                    <div className='row'>
                        <div className="col-lg-8 mx-auto">
                            ...
                            <div className="form-group">
                                <button className='btn btn-primary btn-xl' disabled={!this.state.emailInputValidation.isValid}  onClick={this.nextStep}>Next</button>
                            </div>
                            <InfoBox info="We will be in contact if anything reported found matching your definitions..."></InfoBox>
                        </div>
                    </div>
                </div>
            </section>
